...
82B7	8E 4A               BCH+    BRANCH_8302                 ; Unconditional fwd branch
...
930D	BE CF 3A          SJP       (PRGLINE_TDI + $0A)         ; Transfer, delete, insert row from Input buffer
9310	08                STA	    XH                          ;
9311	09                AND	    (X)                         ;
9312	06                CPA	    XL                          ;
9313	00                SBC	    XL                          ;
...
9746	ED 7B 9F 01       BII	    (OUTBUF + $6F),$01          ; In IN_BUF
...
9839   F4               VEJ         ($F4),(ARX + $05)           ; Loads U-Reg with $7A05
983C   66               DEC         U
